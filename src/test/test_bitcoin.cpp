...
////////////////////////////////////////////////////////////// wynn
        ...
        globalState = std::unique_ptr<WynnState>(new WynnState(dev::u256(0), WynnState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::wynnTestNetwork)));
