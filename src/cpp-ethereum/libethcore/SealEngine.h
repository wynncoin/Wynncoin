...
////////////////////////////////////////////////////////////// // wynn
	void setWynnSchedule(EVMSchedule _wynnSchedule) const { wynnSchedule = _wynnSchedule; }

	EVMSchedule& getWynnSchedule() const { return wynnSchedule; }
...
private:
	...
	mutable EVMSchedule wynnSchedule; // wynn
