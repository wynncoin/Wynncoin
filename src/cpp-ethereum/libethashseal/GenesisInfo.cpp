...
#include "genesis/wynnMainNetwork.cpp"
#include "genesis/wynnTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::wynnMainNetwork: return c_genesisInfoWynnMainNetwork;
	case Network::wynnTestNetwork: return c_genesisInfoWynnTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::wynnMainNetwork: return c_genesisStateRootWynnMainNetwork;
	case Network::wynnTestNetwork: return c_genesisStateRootWynnTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
