...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wynn-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wynn-tx [options] <hex-tx> [commands]  Update hex-encoded wynn transaction\n" +
            "or:     wynn-tx [options] -create [commands]   Create hex-encoded wynn transaction\n" +
            "\n";
