...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // wynn
        hashUTXORoot.SetNull(); // wynn
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //wynn
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //wynn
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //wynn
    {
