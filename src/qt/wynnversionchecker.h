#ifndef WYCVERSIONCHECKER_H
#define WYCVERSIONCHECKER_H

#include <QObject>

#define WYC_RELEASES "https://github.com/wynnproject/wynn/releases"
...
class WynnVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit WynnVersionChecker(QObject *parent = 0);
    ~WynnVersionChecker();
