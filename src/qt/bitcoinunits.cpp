...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("WYC");
    case mBTC: return QString("mWYC");
    case uBTC: return QString::fromUtf8("μWYC (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Wynns");
    case mBTC: return QString("Milli-Wynns (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Wynns (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
